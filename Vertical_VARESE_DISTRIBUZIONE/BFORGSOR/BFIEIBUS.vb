  ...
  Inherits CLEIEIBUS
      ...
      "DAT_ULT_MOD         " & _
       vbCrLf).Replace(" ", "")
            ...
            For Each dtrT As DataRow In dttTmp.Rows
                Ordinamento += 1
                sbFile.Append(FormattaRiga("Nome promozione", "xx_promozione", Ordinamento, dtrT, "prodotti"))
                Ordinamento += 1
                sbFile.Append(FormattaRiga("Data inizio", "xx_data_inizio", Ordinamento, dtrT, "prodotti"))
                Ordinamento += 1
                sbFile.Append(FormattaRiga("Data fine", "xx_data_fine", Ordinamento, dtrT, "prodotti"))
    ...
    Function FormattaRiga(ByVal Label As String, ByVal DBCode As String, ByVal Order As Integer, ByVal Riga As DataRow, ByVal Contesto As String, Optional ByVal isDateFormat As Boolean = False) As String
        ...
        Select Case Riga.Item(DBCode).GetType.Name
            ...
            Case "DateTime"
                sTipoDato = "1"
                FieldValue = ConvData(Riga.Item(DBCode), False)
            Case "Int32"
                sTipoDato = "3"
                FieldValue = ConvStr(Riga.Item(DBCode))
            Case "Decimal"
