...
Public Class CLHIEIBUS
    ...
    Public Overrides Function GetCliforTestDoc(ByVal strTipoCF As String, ByVal strDitta As String, _
                                                ByRef dttOut As System.Data.DataTable, _
        ...
        Try
            ...
            If Not GetCliForTestDoc_Offerte(strDitta, dtOfferte) Then
                Return False
            End If
    ...
    Public Overrides Function GetCliforRighDoc(ByVal strTipoCF As String, ByVal strDitta As String, ByRef dttOut As System.Data.DataTable, ByVal strWhere As String, Optional ByVal strGiorniStoricoDocumenti As String = "365") As Boolean
        ...
        Try
            ...
            If Not GetCliForRigheDoc_Offerte(strDitta, dtOfferte) Then
                Return False
            End If
    ...
    Public Overridable Function GetCliForTestDoc_Offerte(ByVal strDitta As String, ByRef dtTestOfferte As DataTable) As Boolean
        Dim strSql As String = ""
        Try

            strFiltroGGOfferte = GetSettingBusDitt(strDitta, "Bsieibus", "Opzioni", ".", "FiltroGGOfferte", "365", " ", "365").Trim

            strSql = ApexNetLIB.EmbeddedResource.GetString(GetType(CLHIEIBUS).Assembly, "cGetCliforTestDocOfferte.sql")

            strSql = strSql.Replace("@ditta", CStrSQL(strDitta))
            strSql = strSql.Replace("@gg_offerte", CStrSQL(strFiltroGGOfferte))

            dtTestOfferte = OpenRecordset(strSql, CLE__APP.DBTIPO.DBAZI)
    ...
    Public Overridable Function GetCliForRigheDoc_Offerte(ByVal strDitta As String, ByRef dtRigheOfferte As DataTable) As Boolean
        Dim strSql As String = ""
        ...
        Try
            ...
            strSql = ApexNetLIB.EmbeddedResource.GetString(GetType(CLHIEIBUS).Assembly, "cGetCliforRigheDocOfferte.sql")

            strsql = strsql.Replace("@ditta", CStrSQL(strDitta))
            strSql = strSql.Replace("@gg_offerte", CStrSQL(strFiltroGGOfferte))

            dtRigheOfferte = OpenRecordset(strsql, CLE__APP.DBTIPO.DBAZI)
        ...
        Try
            If Lead.cod_lead = "" Or Lead.cod_lead Is Nothing Then
                ...
                ToSql(Lead.internet, 50) & "," & _
                    ...
                    " IsNull( " & ToSql(Lead.cod_valuta) & " , 0) ," & _
