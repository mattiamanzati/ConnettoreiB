...
namespace MonitorFolderActivity
{
    public partial class frmMain : Form
    {
        ...
        System.Drawing.Icon icoRed  = new System.Drawing.Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MonitorFolderActivity.Icons.red.ico"));
        System.Drawing.Icon icoGreen = new System.Drawing.Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MonitorFolderActivity.Icons.green.ico"));
        ...
        private void eventRaised(object sender, System.IO.FileSystemEventArgs e)
        {
            switch (e.ChangeType)
            {
                ...
                case WatcherChangeTypes.Created:
                    ...
                    notifyIcon1.BalloonTipTitle = "iB FileSystem Watcher";
                    notifyIcon1.BalloonTipText = "E' arrivato un nuovo file: [" + e.Name + "]";
                    notifyIcon1.Icon = icoRed;
                    notifyIcon1.ShowBalloonTip(500);
                    break;
                case WatcherChangeTypes.Deleted:
                    TS_AddLogText(string.Format("File {0} has been deleted\r\n", e.FullPath));
                    notifyIcon1.Icon = icoGreen;
                    break;
        ...
        private string GetValue() 
        {
            ...
            key = Microsoft.Win32.Registry.CurrentUser.CreateSubKey("iB FileSystem Watcher");
            string valore;
            try
            {
                valore = key.GetValue("Path").ToString();
            }
            catch {
                valore = "";
            }
        ...
        private void SetValue(string Valore)
        {
            Microsoft.Win32.RegistryKey key;
            key = Microsoft.Win32.Registry.CurrentUser.CreateSubKey("iB FileSystem Watcher");            
            key.SetValue("Path", Valore);
            key.Close();
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            //System.Drawing.Icon icoRed = new System.Drawing.Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MonitorFolderActivity.red.ico"));
            notifyIcon1.Icon = icoGreen;

            string valore = GetValue();
            if (valore != "")
            {
                txtFolderPath.Text = valore;
            }
        ...
        private void frmMain_Resize(object sender, EventArgs e)
        {
            ...
            {
                //notifyIcon1.BalloonTipTitle = "Folder activity";
